  ...
  return (
    <div className="page fade-up">
      <div style={{ marginBottom:32 }}>
        ...
        <h1 style={{ fontSize:28, marginBottom:8 }}>Categories &amp; Difficulties</h1>
        <p style={{ color:'var(--text-3)', fontSize:14 }}>Changes appear everywhere instantly — no redeploy needed.</p>
      </div>
